...
@section('content')
    <div class="row  align-items-center">
        ...
        <div class="col-sm-2 text-right">
            <a href="{{ route('campus.create') }}" class="btn btn-success"><i class="fas fa-plus"></i></a>
        </div>
    </div>
                ...
                @if (isset($content->id ))
                    <tr data-id="{{ $content->id }}" data-order="{{ $content->order }}">
                        ...
                        <td>
                            ...
                            <a href="{{ route('campus.edit', $content->id) }}" class="btn btn-primary">Editar</a>
                            <form action="{{ route('campus.destroy', $content->id) }}" method="post" style="display:inline">
                                @csrf
                                @method('DELETE')
